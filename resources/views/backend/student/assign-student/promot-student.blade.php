...
<div class="col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="panel ">
        <div class="panel-content">
            @if (isset($edit_data))
            <h4 class="pull-left">Student Protmotion</h4>
            ...
            <a href="{{ route('view_student') }}" style="float: right;" class="btn btn-primary btn-sm "> <i class="fa fa-list"></i> View Student List</a> <br>
        </div> <hr>
        <div class="panel-content ">
            <form action="{{ (@$edit_data) ? route("promote_student",$edit_data->student_id) : route('insert_student') }}" id="student_form" method="POST" enctype="multipart/form-data">
                @csrf
