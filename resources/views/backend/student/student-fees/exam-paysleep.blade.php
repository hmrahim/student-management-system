...
<body>
    <div class="row" id="HTMLtoPDF">
        ...
        <div class="middle-section">
            ...
            <div class="table-box">
                @php
                $registrationfee= App\model\admin\FeesAmount::where("fee_category_id","3")->where("class_id",$alldata->class_id)->first();
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td width="30%">{{ $exam_type_name->name }}</td>
                    </tr>
                    <tr>
                        <td width="20%">Exam Fee</td>
                        <td width="30%">{{ $registrationfee->fees_amount}}tk</td>
                    </tr>
                    <tr>
